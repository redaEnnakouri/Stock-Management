...
<main class="login-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Gestion de Stock</div>
...
?><div class="card-body" id="t">
                    ...
                    <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="email_address" name="user" class="form-control" name="email-address" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 offset-md-4">
                               ...
                               <input type="submit" name="submit" class="btn btn-primary"  value="Connexion"></form>
                                </form>
                            </div>
...
var today = new Date();
var tomorrow = new Date(2019, 09, 11,12);
