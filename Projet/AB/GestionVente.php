...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <a type="button" class="btn btn-info" href="GestionVente.php?user=<?php echo $_GET['user']?>">تحديث</a>
...
<center><h2>قائمة المبيعات</h2></center>
    ...
    <tr>
      ...
      <td><?php  echo $row['bon']?></td>
       ...
       <form method="POST" action="excelve.php?bon=<?php echo $row['bon']?>">
            <a href="supp/suppv.php?id=<?php echo $row['bon']?>&user=<?php echo $_GET['user']?>" class="btn btn-danger">إزالة</a>
