...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <a type="button" class="btn btn-info" href="Articles.php?user=<?php echo $_GET['user']?>">تحديث</a>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $c = $row['max'] + 1;
    ?>
       <center> <?php echo $c?>:فاتورة</center>
...
<br>
		...
		<div style="width: 100%">
		<div style="float: right;"><input type="submit" value="تسجيل" class="btn"
					name="submit"></div>
					</div>
	</form>
